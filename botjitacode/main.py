...
async def on_ready():
    ...
    for guild in bot.guilds:
        ...
        await verifica_canal_trade_on_ready(guild, bot)
...
async def on_guild_join(guild):
    ...
    await verifica_canal_trade(guild, bot)
...
async def criarcanaltrocas(ctx):
    guild = ctx.guild
    channel = await verifica_canal_trade(guild, bot)
    if channel:
...
async def troca(ctx):
    ...
    trade_channel = await verifica_canal_trade(ctx.guild, bot)
